...
public class TSP 
{
	  ...
	  */
	 public TSP(int[][] newMap, int newNumCities, int newMaxGeneration, int newNumSamples, TextArea text)
         {
                 textArea = text;
		 map = newMap;
		 ...
		 Search();
		 textArea.appendText("\n");
		 textArea.appendText("The best path found is path: " + bestTour.pathToString() +"\n" );
		 textArea.appendText("Generation: " + bestTour.getGeneration() +"\n");
		 textArea.appendText("Fitness: " + bestTour.getFitness() + "\n");
	 ...
	 public void Search()
	 {
		 ...
		 textArea.appendText("Gen:" + currentGeneration + "\n");
		 ...
		 while(currentGeneration <= maxGeneration) //Keep doing until Max Generation is not complte.
		 {
			...
			//Mutate one item.
			 ...
			 textArea.appendText("Best Route for this Gen: " + oldGen.get(0).getPath() +"\n");
			 textArea.appendText("Fitness: " + oldGen.get(0).getFitness()+"\n");
